export default () => {
  ...
  return {
    ...
    isSmallTablet: computed(() => viewport.isLessThan('tablet') && viewport.isGreaterThan('mobileMedium')),
    isMobile: computed(() => viewport.isGreaterOrEquals('mobile') && viewport.isLessOrEquals('mobileMedium')),
